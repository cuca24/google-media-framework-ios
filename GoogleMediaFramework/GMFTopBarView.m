...
@implementation GMFTopBarView {
  ...
  NSMutableDictionary *tobBarConstraints;
  BOOL showLogoView;
...
- (void)setupLayoutConstraints {
  ...
  if(tobBarConstraints != nil){
    [self removeConstraints:tobBarConstraints];
  }
